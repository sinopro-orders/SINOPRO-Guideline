...
1. **중위기 LP / SP / GW 정보 확인(중위기 디스플레이 화면)** — IP 앞의 세 자리가 모두 `192.168.1.xxx` 인지 확인합니다.
